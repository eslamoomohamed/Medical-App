...
class MAAppointmentsVC: UIViewController {
    ...
    let label0             = MASeconderyLabel(text: "My Appointments", textAlignment: .left, fontSize: 18, textColor: .black, weight: .semibold,numOflines: 0,fitWidth: false)
    ...
    let bookAppointmentBtn = MADefaultBtn(btnTitle: "Book a new appointment", titleColor: .white, backgroundColor: #colorLiteral(red: 0.1647058824, green: 0.1647058824, blue: 0.7529411765, alpha: 1), raduis: 15)
