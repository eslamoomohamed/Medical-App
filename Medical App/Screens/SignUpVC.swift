...
class SignUpVC: UIViewController {
    ...
    let label0             = MASeconderyLabel(text: "Sign Up ", textAlignment: .left, fontSize: 18, textColor: .black, weight: .semibold)
    ...
    let mobileNumLabel     = MASeconderyLabel(text: "Your Mobile", textAlignment: .left, fontSize: 20, textColor: #colorLiteral(red: 0.09411764706, green: 0.07843137255, blue: 0.3803921569, alpha: 1) , weight: .semibold)
