...
class OnBoradingVC: UIPageViewController {
    ...
    func  configureNextBtn(){
        ...
        nextBtn.setTitleColor(#colorLiteral(red: 0.1647058824, green: 0.1647058824, blue: 0.7529411765, alpha: 1) , for: .normal)
...
//        print(pageControl.currentPage)
    ...
    func  configurePrevBtn(){
        ...
        prevBtn.setTitleColor(#colorLiteral(red: 0.1647058824, green: 0.1647058824, blue: 0.7529411765, alpha: 1) , for: .normal)
